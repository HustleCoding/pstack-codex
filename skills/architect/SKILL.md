...
Use the configured arena candidate count. Codex collaboration agents inherit the session runtime, so distinguish candidates by design direction and constraints rather than invented model slugs.
